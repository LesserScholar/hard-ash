...
ash_config = {
    'ash_alpha': Vs([3., 4.], manual_value=4.),
...
optimizers = {
    'rmsprop' : {
        'rmsprop_decay': Vs([0.998, 0.999, 0.9991, 0.9992, 0.9993], manual_value=0.998),
        'learning_rate': Vs([4e-6, 5e-6, 5.5e-6, 6e-6, 8e-6], manual_value=4e-6), #logU(4e-6, 6e-6),
    },
    'adam' : {
